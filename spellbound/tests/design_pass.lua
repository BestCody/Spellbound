...
test("duel notifications do not erase physical-button controls",function()
 local a,b,step=pair();a:tap("START");a:tap("LEFT");step(100)
 assert(has(a,"Fireball cast") and has(a,"LEFT fire  UP shield  RIGHT mana"))
end)
